...
namespace UnoTrains
{
    public class AppDataStorage : IGameStorage
    {
        ...
        {
            return Path.Combine(ApplicationData.Current.LocalFolder.Path, "Trains.NET", fileName);
        }

        private readonly IEntityCollectionSerializer _entitySerializer;
        private readonly ITerrainSerializer _terrainSerializer;

        public AppDataStorage(IEntityCollectionSerializer serializer, ITerrainSerializer terrainSerializer)
        {
